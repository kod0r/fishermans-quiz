...
export function QuizCardShell({
  ...
  return (
    <div className="bg-white/80 backdrop-blur-sm border border-slate-200/50 rounded-xl p-3 sm:p-4 md:p-5 mb-3 sm:mb-4 min-h-[360px] sm:min-h-[480px] md:min-h-[600px] max-h-[calc(100dvh-180px)] flex flex-col overflow-hidden dark:bg-slate-800/60 dark:border-slate-700/50">
      {/* Topic + Favorite */}
