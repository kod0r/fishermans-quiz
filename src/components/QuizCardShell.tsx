...
export function QuizCardShell({
  ...
  return (
    <div className="bg-white/80 backdrop-blur-sm border border-slate-200/50 rounded-xl p-3 sm:p-4 md:p-5 mb-3 sm:mb-4 h-[620px] flex flex-col overflow-hidden dark:bg-slate-800/60 dark:border-slate-700/50">
      {/* Topic + Favorite */}
